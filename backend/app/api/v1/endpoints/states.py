...
@router.post("/", response_model=StateResponse, status_code=201, summary="Create new state")
...
async def update_state(state_id: int, state_update: StateUpdate, db: Session = Depends(get_db)):
    """
